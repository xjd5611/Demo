...
public class ProcEnemyAction : ProcedureBase
{
    ...
    {
        ChangeState<ProcGameOver>(m_procedureOwner);
    }

    private void TakeAction()
    {
        GameEntry.Event.Fire(GameEntry.GameManager.m_actor.Id, MstTakeActionEvent.Create());
    }

    private void OnTakeActionCompleted(object sender, GameEventArgs e)
    {
        ChangeState<ProcTurnEnd>(m_procedureOwner);
    }
